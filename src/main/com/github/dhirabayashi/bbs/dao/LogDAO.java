...
public class LogDAO {
    public void insert(LogDTO log) throws SQLException {
        ...
        try(Connection con = DBManager.getConnection();
            ...
            pstmt.setString(5, log.getPassword()); // 本当は暗号化すべきだが
            pstmt.setTimestamp(6, log.getWriteTime());

            pstmt.executeUpdate();
        }
    }

    public List<LogDTO> selectAll() throws SQLException {
        var sql = "select log_id, name, url, message, password, write_time from log order by write_time desc";
